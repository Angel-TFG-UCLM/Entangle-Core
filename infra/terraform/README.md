...
- `azure/` provides Container Apps API plus staging, ACR, Log Analytics, user-assigned identity/RBAC, Azure AI chat/embedding deployments, Static Web App, and optional alert recipient. The reconciled Bicep template owns Mongo vCore parity due to ARM version/region variability.
