"""
Script para ejecutar ingesta con segmentación dinámica.
...
def main():
    ...
    try:
        ...
        result = engine.run(
            ...
            save_to_json=True,
            output_file="results/ingestion_segmented_results.json"
        )
        ...
        logger.info(f"\n📄 Resultados guardados en: results/ingestion_segmented_results.json")
