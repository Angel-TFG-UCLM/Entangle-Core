...
def main():
    ...
    # Límite de organizaciones (opcional)
    max_orgs_input = input("\n¿Límite de organizaciones? (Enter para todas): ").strip()
    max_orgs = int(max_orgs_input) if max_orgs_input else None
